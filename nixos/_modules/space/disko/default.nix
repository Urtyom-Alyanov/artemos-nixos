...

{
  ...
  config = mkIf moduleConfig.enable {
    disko.devices.disk = let
      genericMountOptions = if moduleConfig.bootDisk.isSsd then genericSsdBtrfs else genericHddBtrfs;
      nocowMountOptions = if moduleConfig.bootDisk.isSsd then nocowSsdBtrfs else nocowHddBtrfs;
    in {
      main = {
    ...
    // (mapAttrs (userName: userCfg: let
      genericMountOptions = if userCfg.isSsd then genericSsdBtrfs else genericHddBtrfs;
      nocowMountOptions = if userCfg.isSsd then nocowSsdBtrfs else nocowHddBtrfs;
    in {
